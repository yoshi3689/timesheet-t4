        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Expiration = table.Column<DateTime>(type: "VARCHAR(250)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Description = table.Column<string>(type: "TEXT", maxLength: 200, nullable: true),
                    CreationTime = table.Column<DateTime>(type: "TEXT", nullable: false),
                    Expiration = table.Column<DateTime>(type: "VARCHAR(250)", nullable: true),
                    ConsumedTime = table.Column<DateTime>(type: "VARCHAR(250)", nullable: true),
                    Data = table.Column<string>(type: "TEXT", maxLength: 50240, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RoleId = table.Column<string>(type: "VARCHAR(250)", nullable: false),
